...
+
. [[Step7]] If you want to use a different certificate than the one displayed, you must first configure it on your StorageGRID system.
...
.. Select *Cancel* to end the discovery process without verifying the certificate. For example, you can select *Cancel* if you receive an error message notifying you that the StorageGRID management certificate needs to be updated. To update a certificate, go to <<Step 7>>.
