...
* A Connector that was installed using version 3.9.43 or later.
+
Discovery isn't supported if the Connector was originally installed using version 3.9.42 or earlier.
+
https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html[Learn more about Connectors and how to create one^]

* The Connector must have network connectivity to the StorageGRID system.
+
The Connector can reside in a cloud provider or on-premises. It just needs a network connection to the StorageGRID system.
