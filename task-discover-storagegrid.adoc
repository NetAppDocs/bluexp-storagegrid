...
* You must have one of the following BlueXP access roles: Org admin, Folder or project admin or Storage admin role to discover a StorageGRID system. [Learn about BlueXP access roles^.]
